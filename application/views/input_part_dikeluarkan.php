...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>Input_part_dikeluarkan</title>
    <link rel="stylesheet" href="../asset/nicepage.css" media="screen">
<link rel="stylesheet" href="../asset/Input_part_dikeluarkan.css" media="screen">
    ...
    <meta property="og:title" content="Input_part_dikeluarkan">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-palette-1-base u-header" id="sec-3f2e"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-a164" data-image-width="1280" data-image-height="720">
      <div class="u-container-style u-group u-palette-1-light-2 u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <div class="u-form u-form-1">
            <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-horizontal u-form-spacing-16 u-inner-form" source="email" name="form" style="padding: 0px;">
              <div class="u-form-group u-form-number u-form-number-layout-number u-label-left u-form-group-1">
                <label for="number-4bbf" class="u-label u-label-1">INPUT QTY</label>
                <div class="u-input-row">
                  <input value="0" min="0" max="100" step="1" type="number" placeholder="" id="number-4bbf" name="qty" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-1">
                </div>
              </div>
        ...
        <table class="u-table-entity">
          ...
          <thead class="u-align-center u-grey-60 u-table-header u-table-header-1">
            <tr style="height: 46px;">
              <th class="u-border-1 u-border-grey-10 u-table-cell">ID</th>
              <th class="u-border-1 u-border-grey-10 u-table-cell">NAMA PART</th>
              <th class="u-border-1 u-border-grey-10 u-table-cell">TYPE</th>
              <th class="u-border-1 u-border-grey-10 u-table-cell">MESIN</th>
              <th class="u-border-1 u-border-grey-10 u-table-cell">QTY</th>
            </tr>
          </thead>
